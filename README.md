...
> Если значение замера уже есть на эту дату, то его значение обновиться
...
4. Значение замера добавится в список сегодняшним днем

#### Быстрое добавление <a name="measure-add-fast"></a>
1. Выберите замер из списка замеров
2. Введите числовое значение
3. Значение замера добавится в список сегодняшним днем
...
5. Значение замера добавиться в список
...
> Если рекорд уже есть на эту дату, то его значение обновиться

#### Добавить сегодня <a name="record-add-today"></a>
1. Выберите рекорд из списка рекордов
2. Нажмите кнопку *Добавить сегодня*
3. Введите числовое значение
4. Значение рекорда добавится в список сегодняшним днем

#### Быстрое добавление <a name="record-add-fast"></a>
1. Выберите рекорд из списка рекордов
2. Введите числовое значение
3. Значение рекорда добавится в список сегодняшним днем
...
Настройки бота, такие как уведомление о замерах и выбранные замеры. Команда **Настройки** в меню или введите `/settings`
...
Можно выбрать выбрать частоту уведомления о замерах или отключить уведомление о замерах
